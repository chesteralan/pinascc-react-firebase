    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 pt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link
            to="/social-and-community/filipino-memes"
          ...
          >
            ...
            <p className="text-gray-600">
              Explore the funniest and most viral Filipino memes.
            </p>
          </Link>
          <Link
            to="/social-and-community/forums-and-qa"
            className="block p-4 border rounded-lg shadow hover:shadow-lg transition-shadow duration-300 group"
          >
            <img
              src="/gallery-2.jpg"
          ...
          <Link
            to="/social-and-community/kabayan-spotlight"
            className="block p-4 border rounded-lg shadow hover:shadow-lg transition-shadow duration-300 group"
          >
            <img
              src="/gallery-3.jpg"
            ...
            <p className="text-gray-600">
              Highlighting the achievements of Filipinos worldwide.
            </p>
          </Link>
          <Link
            to="/social-and-community/social-feeds"
            className="block p-4 border rounded-lg shadow hover:shadow-lg transition-shadow duration-300 group"
          >
            <img
              src="/gallery-4.jpg"
