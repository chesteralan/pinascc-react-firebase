    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 pt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link
            to="/news-and-happenings/business-and-tech"
          ...
          >
            ...
            <p className="text-gray-600">
              Latest trends in Philippine business and technology.
            </p>
          </Link>
          <Link
            to="/news-and-happenings/local-gov-announcements"
            className="block p-4 border rounded-lg shadow hover:shadow-lg transition-shadow duration-300 group"
          >
            <img
              src="/gallery-2.jpg"
            ...
            <p className="text-gray-600">
              Updates from local government units.
            </p>
          </Link>
          <Link
            to="/news-and-happenings/national-headlines"
            className="block p-4 border rounded-lg shadow hover:shadow-lg transition-shadow duration-300 group"
          >
            <img
              src="/gallery-3.jpg"
            ...
            <p className="text-gray-600">
              Curated national news and current events.
            </p>
          </Link>
          <Link
            to="/news-and-happenings/positive-stories"
            className="block p-4 border rounded-lg shadow hover:shadow-lg transition-shadow duration-300 group"
          >
            <img
              src="/gallery-4.jpg"
            ...
            <p className="text-gray-600">
              Heartwarming stories from the provinces.
            </p>
          </Link>
        </div>
      </div>
