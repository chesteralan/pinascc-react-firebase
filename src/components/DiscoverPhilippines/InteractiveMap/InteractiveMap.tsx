      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-10">
          ...
          <p className="text-base text-gray-500 max-w-md text-right leading-relaxed">
            Navigate through the provinces of the Philippines with our interactive map.
            Discover key attractions, local insights, and travel routes for each region.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-start-3 relative bg-gray-100 rounded-lg shadow-lg overflow-hidden md:row-start-2 md:col-span-1 group">
            <div className="flex flex-col md:flex-row">
              <img src="/gallery-4.jpg" alt="Palawan" className="w-full md:w-1/2 h-48 md:h-auto object-cover transition-transform duration-300 group-hover:scale-105" />
