    ...
    <section className="py-12 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 (Vertical) */}
          <Link
            to="/discover-philippines/interactive-map/interactive-map-luzon"
          ...
          {/* Card 2 (Vertical) */}
          <Link
            to="/discover-philippines/interactive-map/interactive-map-visayas"
            className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group block"
          >
            <img
          ...
          {/* Card 3 (Vertical) */}
          <Link
            to="/discover-philippines/interactive-map/interactive-map-mindanao"
            className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group block"
          >
            <img
          ...
          {/* Card 5 (Vertical) */}
          <Link
            to="/discover-philippines/interactive-map/interactive-map-boracay"
            className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group block"
          >
            <img
          ...
          {/* Card 6 (Vertical) */}
          <Link
            to="/discover-philippines/interactive-map/interactive-map-cebu"
            className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group block"
          >
            <img
          ...
          {/* Card 4 (Vertical) */}
          <Link
            to="/discover-philippines/interactive-map/interactive-map-palawan"
            className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group block"
          >
            <img
