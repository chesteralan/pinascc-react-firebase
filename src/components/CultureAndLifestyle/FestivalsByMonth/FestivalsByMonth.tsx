      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-10">
          ...
          <p className="text-base text-gray-500 max-w-md text-right leading-relaxed">
            Discover the vibrant festivals celebrated across the Philippines throughout the year.
            Plan your visit around these colorful and lively cultural events.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Ati-Atihan Festival</h3>
          ...
          <div className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Panagbenga Festival</h3>
              <div className="flex items-center text-yellow-500 text-sm">
          ...
          <div className="relative bg-gray-100 rounded-lg shadow-lg overflow-hidden group">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Araw ng Dabaw</h3>
              <div className="flex items-center text-yellow-500 text-sm">
          ...
          <div className="md:col-start-3 relative bg-gray-100 rounded-lg shadow-lg overflow-hidden md:row-start-2 md:col-span-1 group">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-6 flex-1">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Moriones Festival</h3>
                <div className="flex items-center text-yellow-500 text-sm">
