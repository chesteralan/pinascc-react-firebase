...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Top Bar */}
      <div
        className={`bg-gray-700 text-white text-sm py-2 ${scrolled ? "hidden" : "block"}`}
      >
      ...
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <span
            className={`ml-2 text-xl font-bold ${scrolled ? "text-gray-800" : "text-white"}`}
          >
            Pinas.cc
          </span>
        </div>
        <nav className="hidden md:flex items-center space-x-4">
          <a
            href="#"
            className={`hover:text-gray-800 ${scrolled ? "text-gray-600" : "text-white"}`}
          >
            HOME
          </a>
          <a
